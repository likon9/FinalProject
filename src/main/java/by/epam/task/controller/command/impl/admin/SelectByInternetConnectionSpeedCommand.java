...
public class SelectByInternetConnectionSpeedCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        try {
            tariffPlanList =tariffPlanService.findByInternetConnectionSpeed(Integer.parseInt(request.getParameter(ParameterName.INTERNET_CONNECTION_SPEED)));
            ...
            logger.error("Error in viewing select by name tariff plans" + e);
