...
<div class="form1">
    ...
    <form action="controller" method="get">
        ...
        <input class="input_text"type="password" name="password" placeholder="<fmt:message key="registration.password"/>" minlength="6" required pattern="[0-9A-Za-z]{6,24}"/><br>
        ...
        <input class="input_text"type="text" name="phone" placeholder="<fmt:message key="registration.phone"/>" length="9" required pattern="[0-9]{9}"/><br>
